...
- method:
  ...
  Character (default: "G2"). Formula used to estimate kurtosis.
  Available options are c("G2", "b2", "g2"). The "g2" statistic is the
  classical sample kurtosis estimator, while "G2" and "b2" are
  bias-corrected versions of "g2".
...
equal to 3, which is the kurtosis of a normal distribution. Values
significantly different from 3 indicate deviations from normality, such
as heavy-tailed or light-tailed behavior.
