...
- Modified [`check_normality()`](../reference/check_normality.md),
...
- Implement [`Lilliefors_test()`](../reference/Lilliefors_test.md)
...
- Implement [`Shapiro_Wilk_test()`](../reference/Shapiro_Wilk_test.md)
  (original, Francia, and Royston versions).
- Implement a handy wrapper: [`is_normal()`](../reference/is_normal.md).
